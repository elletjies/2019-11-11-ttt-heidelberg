...
instructors: ["Malvika Sharan (in-person)", "Rayna Harris (joining remotely)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helpers: ["Paula Andrea Martinez", "Nicolás Palopoli"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]

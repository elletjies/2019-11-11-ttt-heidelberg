...
instructor: ["Malvika Sharan (in-person)", "Rayna Harris and Nicolás Palopoli(joining remotely)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Meet a few trainers who will be joining remotely", "Paula Andrea Martinez", "TBA"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
